...
> P12 · PRD v2.0 · 콘텐츠 `1.6.0-blood` · 런 저장 v8
...
- **캐릭터**: 화염 격투가, 수호자, 번개 결투사, 냉기 도적, 마도기사, 혈액 마검사
...
| [`docs/PRD.md`](docs/PRD.md) | 제품 요구사항과 게임 규칙의 단일 정본. PRD v2.0 |
| [`PRD/P10_CHARACTER_DESIGN_SYNC.md`](PRD/P10_CHARACTER_DESIGN_SYNC.md) | 화염 전사·마도기사 최신 통합 기획과 구현 결정 |
| [`PRD/P11_COLD_ROGUE_DESIGN_SYNC.md`](PRD/P11_COLD_ROGUE_DESIGN_SYNC.md) | 냉기 도적 기획과 구현 결정 기록 |
| [`PRD/P12_BLOOD_SPELLBLADE_DESIGN_SYNC.md`](PRD/P12_BLOOD_SPELLBLADE_DESIGN_SYNC.md) | 혈액 마검사 기획과 구현 결정 기록 |
