...
const withHand = (state: CombatState): CombatState => ({
  ...
  coins: {
    ...
    2: { uid: coin(2), permanentUid: 2 as never, defId: id<CoinDefId>("fire"), permanent: true, grants: [] },
    3: { uid: coin(3), permanentUid: 3 as never, defId: id<CoinDefId>("basic"), permanent: true, grants: [] },
    4: {
      uid: coin(4),
