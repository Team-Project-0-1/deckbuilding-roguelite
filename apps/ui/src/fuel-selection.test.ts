...
const withHand = (state: CombatState): CombatState => ({
  ...
  coins: {
    ...state.coins,
    1: { uid: coin(1), permanentUid: 1 as never, defId: id<CoinDefId>("basic"), permanent: true, grants: [] },
    2: {
      uid: coin(2),
    ...
    3: { uid: coin(3), permanentUid: 3 as never, defId: id<CoinDefId>("fire"), permanent: true, grants: [] },
    4: {
      uid: coin(4),
    ...
    5: { uid: coin(5), permanentUid: 5 as never, defId: id<CoinDefId>("mana"), permanent: true, grants: [] },
  },
  zones: {
    ...state.zones,
...
const withFrostHand = (state: CombatState): CombatState => ({
  ...
  coins: {
    ...state.coins,
    1: { uid: coin(1), permanentUid: 1 as never, defId: id<CoinDefId>("frost"), permanent: true, grants: [] },
    2: { uid: coin(2), permanentUid: 2 as never, defId: id<CoinDefId>("frost"), permanent: true, grants: [] },
    3: { uid: coin(3), permanentUid: 3 as never, defId: id<CoinDefId>("frost"), permanent: true, grants: [] },
    4: { uid: coin(4), permanentUid: 4 as never, defId: id<CoinDefId>("frost"), permanent: true, grants: [] },
    5: { uid: coin(5), permanentUid: 5 as never, defId: id<CoinDefId>("basic"), permanent: true, grants: ["frost"] },
    6: { uid: coin(6), permanentUid: 6 as never, defId: id<CoinDefId>("frost"), permanent: true, grants: [] },
  },
  zones: {
    ...state.zones,
    hand: [coin(1), coin(2), coin(3), coin(4), coin(5)],
